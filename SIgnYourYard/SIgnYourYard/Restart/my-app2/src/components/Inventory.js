      ...
      <div className= "padding">
          <div className= "inventory">
              ...
              {this.state.stocks[153]}
                  ...
                  ) : (<button onClick={this.upperdate}>Update Stock?</button>)}
          </div>
      </div>
    );
  }}
